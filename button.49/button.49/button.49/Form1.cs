...
namespace button._49
{
    public partial class Form1 : Form
    {
        ...
        {
            kitapListe.Add(new Kitap(1, "Kitaplar", "Meryem","205", "Romantik", new DateTime(2004, 1, 20), false));
            kitapListe.Add(new Kitap(2, "Saçma", "Ayda","440", "Aksiyon", new DateTime(2020, 10, 30), true));
            kitapListe.Add(new Kitap(3, "Hayal Dünyası", "Büsra","250", "Eğlence", new DateTime(2021, 3, 10), true));
            kitapListe.Add(new Kitap(4, "BENİM Evrenim", "Elmas","830", "Romantik", new DateTime(2019, 8, 2), true));
